...
const Profile = () => {
  ...
  const handleImageChange = (e) => {
    ...
    setProfile({ ...profile, profile_image: URL.createObjectURL(e.target.files[0]) });
  };
        ...
        <div className="row">
          ...
          <div className="col-md-3 text-center">
            <div className="profile-avatar mb-3" style={{ position: 'relative' }}>
              <img
                src={profile.profile_image ? `${API_URL}/uploads/${profile.profile_image}` : '/default-avatar.png'}
                alt="Profile"
          ...
          <div className="col-md-9">
            <form onSubmit={handleProfileUpdate} style={{border:'1px solid blue', padding: '20px', borderRadius: '8px'}}>
              <div className="mb-3">
